  ...
  render() {
    ...
    return (
      <div className="d-flex justify-content-center my-5">
        <div
          className=" col-10 mx-auto col-md-4  lg-col-5  mt-2"
          style={divContainer}
        >
          <h2 className="font-weight-bold text-center text-uppercase mb-2">
            Contact US
          </h2>
          <form>
            <div className="form-group ">
              ...
              <button
                ...
                className="btn btn-block    btn-warning mb-3 text-uppercase"
              >
                Submit
              </button>
            </div>
